    ...
    return {
        ...
        render: function () {
            ...
            function d() {
                ...
                $("head").append('<link rel="stylesheet" href="https://owcdt.club/discord-widget-master/light.min.css" type="text/css" />');
                ...
                function j(y, n) {
                    ...
                    if (typeof (n.hideChannels) !== "boolean" || !n.hideChannels) {
                        if (n.alphabetical) {
                            ...
                            for (var t = 0; t < v.length; t++) {
                                var channelcount=0;
                                for (var s = 0; s < y.members.length; s++) {
                                    if(f(y.members[s], v[t].id)!="")
                                        channelcount++;
                                }
                                if(channelcount>0)
                                    {u += g(v[t].name);usercount++;
                                    }
                    ...
                    if (n.showAllUsers) {
                        ...
                        for (var t = 0; t < y.members.length; t++) {
                            if (!y.members[t].channel_id || $.inArray(y.members[t].channel_id, o) >= 0) {
                                if(y.members[t].id != 534589798267224065 && y.members[t].id != 185476724627210241 && y.members[t].id != 184405311681986560 && y.members[t].id != 159985870458322944 && y.members[t].id != 328762196668579840){
                                    usercount++;
                    ...
                    l.innerHTML = u;
                    w.innerHTML = "Users Online: " + usercount;
                    if (n.join) {
                        x.innerHTML = B
                    } else {
